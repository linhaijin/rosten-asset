...
class BookCards {
	...
	//资产编号
	@GridColumn(name="资产编号",colIdx=1,formatter="bookCards_formatTopic")
	String registerNum
    ...
    static constraints = {
		...
		userCategory nullable:true,blank:true		//原则上不允许为空
		assetName nullable:false,blank:false
		userDepart nullable:true,blank:true			//原则上不允许为空
