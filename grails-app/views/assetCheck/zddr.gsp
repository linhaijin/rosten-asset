...
<body>
	<div style="text-Align:center">
           <form data-dojo-type="dijit/form/Form" method="post" class="rosten_form" id="file_form" style="width:560px;text-align:left" 
        	target="upload_iframe" enctype="multipart/form-data" action="${createLink(controller:'inventoryTask',action:'zddrSubmit',params:[])}">
                    ...
                    <tbody>
						...
						<tr style="text-align:center">
							<td colspan="2">
								...
								<button data-dojo-type="dijit/form/Button" data-dojo-props='onClick:function(){rosten.openNewWindow("assetCheck", rosten.webPath + "/templates/zddrTemplate.xls");}'>模板下载</button>
								<button data-dojo-type="dijit/form/Button" type="submit" data-dojo-props=''>确定</button>
								<button data-dojo-type="dijit/form/Button" data-dojo-props='onClick:function(){rosten.variable.dialog.hide();
								rosten.variable.dialog.destroy();}'>取消</button>
								</div>
							</td>
						</tr>
                    </tbody>
