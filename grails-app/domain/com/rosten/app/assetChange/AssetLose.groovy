...
class AssetLose {
	...
	//申请单号
	@GridColumn(name="申请单号",colIdx=1,formatter="assetLose_formatTopic")
...
//	@GridColumn(name="申请人",width="100px",colIdx=3)
	...
	//使用部门
	Depart usedDepart
	@GridColumn(name="使用部门",width="120px",colIdx=3)
	...
	//使用人
	@GridColumn(name="使用人",width="70px",colIdx=4)
	String usedMan
...
//	}
	...
	//资产总和
	@GridColumn(name="资产总和（元）",width="100px",colIdx=5)
	Double assetTotal = 0
	
	//报失原因
	@GridColumn(name="报失原因",colIdx=6)
	String applyDesc
