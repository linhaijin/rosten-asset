...
class FurnitureCards {
	...
	//资产编号
	@GridColumn(name="资产编号",colIdx=1,formatter="furnitureCards_formatTopic")
	String registerNum
...
//	static belongsTo = [company:Company,furnitureRegister:FurnitureRegister]
